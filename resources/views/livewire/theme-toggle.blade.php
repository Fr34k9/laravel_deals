<div>
    <button @click="darkMode=!darkMode" type="button"
        class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer bg-zinc-200 dark:bg-zinc-700 w-11 focus:outline-none focus:ring-2 focus:ring-neutral-700 focus:ring-offset-2"
        ...
        <span
            ...
            <span
                ...
                aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 icon icon-tabler icon-tabler-sun text-neutral-700"
            ...
            <span
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="w-4 h-4 icon icon-tabler icon-tabler-moon text-neutral-700" width="24" height="24"
